...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { brewer: @beer.brewer, name: @beer.name, store: @beer.store, style: @beer.style } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { brewer: @beer.brewer, name: @beer.name, store: @beer.store, style: @beer.style } }
